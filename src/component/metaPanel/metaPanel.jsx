...
import {Accordion,Icon,Segment,Header, Image, List, Modal} from 'semantic-ui-react'

const MetaPanel =({currentChannel,privateChannel,currentUser,setUsersPost,closeModal, metalPanel})=>{
   ...
   (num > 1 || num === 0) ? `${num} posts` : `${num}post`
    ...
    return (
        ...
        <Modal basic open={metalPanel}  onClose={closeModal} >
            <Modal.Content>
             <Icon name='remove circle' onClick={closeModal}  />
